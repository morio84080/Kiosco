...
{
    public partial class RptResumenVentaPorRubro : Form
    {
        public RptResumenVentaPorRubro()
        {
            InitializeComponent();
        }

        private void RptResumenVentaPorRubro_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                rptViewer.ServerReport.ReportPath = System.Configuration.ConfigurationSettings.AppSettings["RS_path"].ToString() + "/ResumenVentasPorRubro";
