...
{
    public partial class RptCtaCteCliente : Form
    {
        public RptCtaCteCliente()
        {
            InitializeComponent();
        }

        private void RptCtaCteCliente_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                pa.Add(new ReportParameter("cliente", (param[2] == "" ? null : param[2])));
                pa.Add(new ReportParameter("nombreCliente", (param[3] == "" ? null : param[3])));
                pa.Add(new ReportParameter("Saldo", (param[4] == "" ? null : param[4])));
                ...
                rptViewer.ServerReport.ReportPath = System.Configuration.ConfigurationSettings.AppSettings["RS_path"].ToString() + "/CtaCteCliente";
