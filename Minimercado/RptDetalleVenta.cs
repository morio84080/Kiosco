...
{
    public partial class RptDetalleVenta : Form
    {
        public RptDetalleVenta()
        {
            InitializeComponent();
        }

        private void RptDetalleVenta_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                rptViewer.ServerReport.ReportPath = System.Configuration.ConfigurationSettings.AppSettings["RS_path"].ToString() + "/VentaDetalle";
