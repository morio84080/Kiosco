...
{
    public partial class RptDocElectronico : Form
    {
        public RptDocElectronico()
        {
            InitializeComponent();
        }

        private void RptDocElectronico_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                pa.Add(new ReportParameter("ptoVta", "000" + System.Configuration.ConfigurationManager.AppSettings["PtoVta"]));
                ...
                rptViewer.ServerReport.ReportPath = System.Configuration.ConfigurationManager.AppSettings["RS_path"].ToString() + "/DocumentosElectronicos";
