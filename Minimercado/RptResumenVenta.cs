...
{
    public partial class RptResumenVenta : Form
    {
        public RptResumenVenta()
        {
            InitializeComponent();
        }

        private void RptResumenVenta_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                rptViewer.ServerReport.ReportPath = System.Configuration.ConfigurationSettings.AppSettings["RS_path"].ToString() + "/ResumenVentas";
